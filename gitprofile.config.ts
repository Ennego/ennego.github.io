  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['distant-viewing/iad-demo', 'ennego/cross-program-awards-affiliations'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
